...
export default function Diet() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <TouchableOpacity
        style={styles.card}
        onPress={() => router.push("/userFrontend/diet/createDiet")}
      >
      ...
      <TouchableOpacity
        style={styles.card}
        onPress={() => router.push("/userFrontend/diet/viewDiet")}
      >
      ...
      <TouchableOpacity
        style={styles.card}
        onPress={() => router.push("/userFrontend/diet/createDietReference")}
      >
      ...
      <TouchableOpacity
        style={styles.card}
        onPress={() => router.push("/userFrontend/diet/viewDietReference")}
      >
