...
export default function Diet() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <TouchableOpacity
        style={styles.card}
        onPress={() => router.push("/OuterUserFrontend/diet/createDiet")}
      >
      ...
      <TouchableOpacity
        style={styles.card}
        onPress={() => router.push("/OuterUserFrontend/diet/viewDiet")}
      >
      ...
      <TouchableOpacity
        style={styles.card}
        onPress={() =>
          router.push("/OuterUserFrontend/diet/createDietReference")
        }
      >
      ...
      <TouchableOpacity
        style={styles.card}
        onPress={() => router.push("/OuterUserFrontend/diet/viewDietReference")}
      >
