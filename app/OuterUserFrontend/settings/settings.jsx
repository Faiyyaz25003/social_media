    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.section}>
        ...
        <SettingItem
          icon="person-outline"
          title="Profile"
          onPress={() => router.push("/OuterUserFrontend/profile/profile")}
        />
        <SettingItem
          icon="lock-closed-outline"
          title="Change Password"
          onPress={() =>
            router.push("/OuterUserFrontend/changePassword/changePassword")
          }
        />
      </View>
      ...
      <View style={styles.section}>
        ...
        <SettingItem
          ...
          title="Diet Settings"
          onPress={() => router.push("/OuterUserFrontend/diet/diet")}
        />
        <SettingItem
          icon="barbell-outline"
          title="Exercise Preferences"
          onPress={() => router.push("/OuterUserFrontend/exercise/exercise")}
        />
      </View>
      ...
      <View style={styles.section}>
        ...
        <SettingItem
          ...
          title="About App"
          onPress={() => router.push("/OuterUserFrontend/settings/about")}
        />
        <SettingItem
          icon="help-circle-outline"
          title="Help & FAQ"
          onPress={() => router.push("/OuterUserFrontend/settings/help")}
        />
        <SettingItem
          icon="document-text-outline"
          title="Privacy Policy"
          onPress={() => router.push("/OuterUserFrontend/settings/privacy")}
        />
      </View>
      ...
      <View style={styles.section}>
        ...
        <SettingItem
          ...
          title="Logout"
          danger
          onPress={() => router.replace("/OuterUserFrontend/auth/login")}
        />
